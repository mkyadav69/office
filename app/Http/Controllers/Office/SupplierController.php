...
class SupplierController extends Controller
{
    ...
    public function showSupplier(){
        return view('office.supplier.show_supplier');
    }
    ...
    public function addSupplier(){
        ...
        if(!empty($source)){
            $source = $source->pluck('pro_source', 'id')->toArray();
        }
        $currency = Config::get('constant.currency');
        $payment_term = Config::get('constant.payment_term');
        
        return view('office.supplier.add_supplier', compact('currency', 'payment_term', 'source'));
    }
    ...
    public function getSupplier(Request $request){
        ...
        if(Auth::user()->hasPermission('delete_supplier')){
        ...
        if(Auth::user()->hasPermission(['update_supplier', 'delete_supplier'])){

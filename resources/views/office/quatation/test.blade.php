...
<body style="background-color: #d6d6d6; color:#5c5c5c;font-size:14px !important;">
    <center class="wrapper">
        <div class="webkit">
            <table class="table-outer" align="center" style="page-break-inside: avoid;background:#ffffff; max-width:1000px; width: 100%; margin:0 auto;">
                            ...
                            <tr>
                                <td colspan="2" align="center" ><strong style="color:#074e90;">
                                     <strong>Call:</strong> 91-022-43159100/24082098/99 &nbsp;&nbsp;&nbsp;&nbsp;
                                      ...
                                      <strong style="color:#333333;">Email:</strong> sales@chromatographyworld.com  &nbsp;&nbsp;
               ...
               <tr style="background:#f1f1f1;">
                    <td>
                        <table class="body" style="font-size:14px;  max-width:1100px; padding:0px 20px; width: 100%; background: #ffffff;">
                            <tr>
                                <td  align="center" colspan="8" style="padding:5px;text-align:center;"><strong style="color: #800712; font-size:22px;">Quotation</strong></td>
                            </tr>
                            ...
                            <tr style=" background: #f1f1f1;">
                               ...
                               <td colspan="2" style="border-top:1px solid #808080; padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080;"> <?php echo ucwords(strtolower($customer_info['st_com_name'])); ?></td>
                            ...
                            <tr style="background: #f1f1f1;">
                                ...
                                <td colspan="6" style="padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080;  ">
                                    <p style="margin: 0;">
                                        <?php echo ucwords(strtolower($quotation_info['st_shiping_add'])); ?>  
                                    </p>
                                </td>
                            </tr>
                             <!-- <tr style="background: #f1f1f1;">
                            ...
                            <tr style="background: #f1f1f1;">
                               ...
                               <td style="padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080;"> <?php echo ucwords(strtolower($quotation_info['st_shiping_city'])); ?></td>
                                <td style="padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080; color:#052390;"><strong>State</strong></td>
                               
                                <td style="padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080;"><?php echo ucwords(strtolower($quotation_info['st_shiping_state'])); ?></td>

                                 <td style="padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080; color:#052390;"><strong>Pincode</strong></td>
                               
                                <td colspan="2" style="padding:5px;border-right:1px solid #808080; border-bottom:1px solid #808080;"><?php echo ucwords(strtolower($quotation_info['st_shiping_pincode'])); ?></span></td> 
                            </tr>
                             ...
                             <tr style="background: #f1f1f1;">
                               ...
                               <td style="padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080;"> 
                                ...
                                <td style="padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080;"><?php echo ucwords(strtolower($customer_info['st_cust_mobile'])); ?></td>

                                 <td style="padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080; color:#052390;"><strong>Email Id</strong></td>
                               
                                <td colspan="2" style="padding:5px;border-right:1px solid #808080; border-bottom:1px solid #808080;"><?php echo ucwords(strtolower($quotation_info['st_shipping_email'])); ?></td> 
                            </tr>

                             <tr style="background: #f1f1f1;">
                                <td style="border-left:1px solid #808080; padding:5px; border-right:1px solid #808080;  border-bottom:1px solid #808080; color:#052390;"><strong>Quotation No. #</strong></td>

                               <td style="padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080;">
							   <?php if(isset($quotation_info['in_quot_num'])) { echo $quotation_info['in_quot_num']; }?>
								</td>
                                ...
                                <td style="padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080;"><?php echo  date("d/m/Y", strtotime($quotation_info['dt_ref']));?></td>

                                 <td style="padding:5px;border-right:1px solid #808080;  border-bottom:1px solid #808080; color:#052390;"><strong>Enq. Ref.</strong></td>
                               
                                <td colspan="2" style="padding:5px;border-right:1px solid #808080; border-bottom:1px solid #808080;"><?php echo ucwords(strtolower($quotation_info['st_enq_ref_number'])); ?></td> 
                            </tr>
              ...
              <tr style="background:#f1f1f1;">
                    <td>
                        <table class="body" style=" font-size:14px; max-width:1200px; padding:10px 20px; width: 100%; background: #ffffff;">
                            <tr style="background: #f1f1f1; border-top:1px solid #808080;">
                                ...
                                <th style="color:#052390; border-top:1px solid #808080;border-right:1px solid #808080; border-bottom:1px solid #808080;padding: 10px 5px;">Unit Price</th>
                            ...
                            <td style="border-top:1px solid #808080;border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;text-align: right;"><?php echo $currency." ".number_format($row_val->fl_pro_unitprice); ?></td>
                            ...
                            <td  style="border-top:1px solid #808080;border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;text-align: right;"><?php echo $currency." ".number_format($row_val->fl_net_price); ?></td>
							<?php if(isset($customer_info['st_cust_state']) and $customer_info['st_cust_state'] != 'Maharashtra'){
                           ...
                           <td  style="border-top:1px solid #808080;border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;text-align: right;"><?php echo $currency." ".$gst_amt_calculation; ?></td>

                            <td  style="border-top:1px solid #808080;border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;"><?php echo $igst_cgst_rate; ?>%</td>
                            <td  style="border-top:1px solid #808080;border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;text-align: right;"><?php echo $currency." ".$gst_amt_calculation; ?></td>
							<?php } ?>
                            <td  style="border-top:1px solid #808080;border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;text-align: right;"><?php echo $currency." ".number_format($row_val->fl_row_total); ?></td>
				...
				<?php  if(isset($row_val->prod_comments) && $row_val->prod_comments !=''){ ?>
                           ...
                           <td align="right" style="border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;"><?php echo number_format($fl_fleight_pack_charg); ?></td>
                            ...
                            <td align="right" style="border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;"><?php echo number_format($quotation_info['fl_fleight_pack_charg']); ?></td>
							...
							-->
                             <tr style="background:#c0d8d3">
								...
								<td  style="border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;text-align: right;"><?php echo $currency." ".number_format($prod_unit_price_total); ?></td>

								<td align="right" style="border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;">&nbsp;</td>

								<td  style="border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;text-align: right;"><?php echo $currency." ".number_format($prod_net_amt_total); ?></td>

								<td align="right" style="border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;">&nbsp;</td>
								

                           <?php if(isset($customer_info['st_cust_state']) and $customer_info['st_cust_state'] != 'Maharashtra'){ ?>
								<td  style="border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;text-align: right;"><?php echo $currency." ".number_format($out_of_mh_gst_total); ?></td>
								<td  style="border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;text-align: right;"><?php echo $currency." ".number_format($quotation_info['fl_nego_amt']); ?></td>
							<?php } else { ?>
							<td  style="border-right:1px solid #808080;border-bottom:1px solid #808080;padding: 10px 5px;text-align: right;"><?php echo $currency." ".$mh_gst_total; ?></td>
                            ...
                            <tr>
                                <td  style="float: left; margin: 10px;">
								   ...
								   <p>
									...
									B)      Payment Terms : <?php echo $quotation_info['st_pay_turm']; ?><br/>

									C)      Any Government / Local Body Levies, taxes, Cess, Duties, Octroi will be extra "At Actuals"</p>
								</td>  
								<td>
                         <table class="table-outer" align="center" style="background:#ffffff; max-width:1000px; width: 100%; margin:0 auto; padding: 5px 20px;">
                            <tr>
                                ...
                                <td align="right" style="padding:0px 12px">
                                    ...
                                    <p style="margin:0">
									<?php if(isset($preparing_by)){ echo $preparing_by; } ?>
                                </td>
                            </tr>
                         </table>
                    </td>
